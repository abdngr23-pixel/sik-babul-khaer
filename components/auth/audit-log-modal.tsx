  ...
  return (
    ...
    >
      <div className="bg-white rounded-t-3xl md:rounded-2xl shadow-2xl border-t md:border border-slate-200 w-full md:max-w-4xl h-[88dvh] max-h-[90dvh] md:h-auto md:max-h-[92dvh] flex flex-col overflow-hidden animate-in slide-in-from-bottom duration-300 md:zoom-in-95">
        ...
        {/* Header */}
        <div className="px-4 py-3 sm:px-6 sm:py-4 bg-gradient-to-r from-slate-900 via-slate-855 to-slate-900 text-white flex items-center justify-between border-b border-slate-800 shrink-0">
          <div className="flex items-center gap-2.5 sm:gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <h3 id="audit-log-title" className="text-sm sm:text-base font-bold text-white flex items-center gap-1.5 sm:gap-2 leading-tight truncate">
