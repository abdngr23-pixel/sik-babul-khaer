      ...
      {activeSubTab === 'turso' && (
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-soft-sm space-y-3">
              <h4 className="text-xs font-bold uppercase tracking-wider text-slate-400">
                Tabel Basis Data Yang Dikelola
              </h4>
              <div className="grid grid-cols-2 gap-2 text-xs">
                {['letters', 'jamaah', 'transactions', 'assets', 'donors', 'approvals', 'minutes', 'audit_logs', 'dakwah_khatib', 'dakwah_ramadhan'].map((tbl) => (
                  <div key={tbl} className="p-2 rounded-xl bg-slate-50 flex items-center gap-1.5 font-mono text-[11px] text-slate-700 font-semibold">
