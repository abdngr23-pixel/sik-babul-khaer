    ...
    <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/80 dark:border-slate-800 shadow-soft-sm p-5">
      <div className="flex items-center justify-between mb-4">
        ...
        <button
          ...
          className="px-3 py-1.5 rounded-xl bg-emerald-50 dark:bg-emerald-950/60 hover:bg-emerald-100 dark:hover:bg-emerald-900/60 text-emerald-800 dark:text-emerald-300 text-xs font-bold border border-emerald-200 dark:border-emerald-800 flex items-center gap-1.5 transition-all cursor-pointer shadow-2xs"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        ...
        <div className="p-3.5 rounded-xl bg-amber-50/80 dark:bg-amber-950/30 border border-amber-200/80 dark:border-amber-800/50">
          <span className="text-[11px] font-semibold text-amber-800 dark:text-amber-300 uppercase tracking-wider block">
            Dana Swadaya PHBI
          </span>
          <span className="text-base font-bold text-amber-900 dark:text-amber-200 block mt-1">
        ...
        <div className="p-3.5 rounded-xl bg-purple-50/80 dark:bg-purple-950/30 border border-purple-200/80 dark:border-purple-800/50">
          <span className="text-[11px] font-semibold text-purple-800 dark:text-purple-300 uppercase tracking-wider block">
            Rekapitulasi ZISWAF
          </span>
          <span className="text-base font-bold text-purple-900 dark:text-purple-200 block mt-1">
            {financeSummary ? formatRupiah(financeSummary.ziswafBalance) : 'Rp 0'}
          </span>
          <span className="text-[10px] text-purple-700 dark:text-purple-400 mt-1 block">
