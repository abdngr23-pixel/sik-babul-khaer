        ...
        <div>
          ...
          <div className="flex overflow-x-auto snap-x snap-mandatory gap-3 pb-2 -mx-3.5 px-3.5 no-scrollbar overscroll-x-contain">
            ...
            {showLetters && (
              <div
                onClick={() => onNavigateTab('archive')}
                className="snap-start shrink-0 w-[260px] bg-white rounded-2xl p-4 border border-slate-200/90 shadow-soft-sm active:scale-98 transition-all cursor-pointer flex flex-col justify-between min-h-[140px]"
              >
                ...
                <div className="pt-2.5 mt-2 border-t border-slate-100 flex items-center justify-between text-[11px] font-semibold text-emerald-700">
            ...
            {showJamaah && (
              ...
              >
                ...
                <div className="pt-2.5 mt-2 border-t border-slate-100 flex items-center justify-between text-[11px] font-semibold text-teal-700">
            ...
            {showAssets && (
              ...
              >
                ...
                <div className="pt-2.5 mt-2 border-t border-slate-100 flex items-center justify-between text-[11px] font-semibold text-indigo-700">
            ...
            {showReports && (
              ...
              >
                ...
                <div className="pt-2.5 mt-2 border-t border-purple-100 flex items-center justify-between text-[11px] font-semibold text-purple-700">
